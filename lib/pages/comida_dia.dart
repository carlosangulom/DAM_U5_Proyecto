          ...
          child: ListView(
            children: [
              ListViewPicker(
                ...
                data: authService.comidasDia,
                initialValue: authService.comidasDia[0],
                itemBuilder: (item) {
                  return Container(
                    height: 170,
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(item.data["imagen"]),
                            fit: BoxFit.cover),
                        boxShadow: const [
                          BoxShadow(
                ...
                onChanged: (context, item, selectedItem, selectedListItem) {},
              )
            ],
          ),
        ));
